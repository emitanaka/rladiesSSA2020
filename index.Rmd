...
.footer[
<a href="https://twitter.com/statsgen"><i class="fab fa-twitter"></i>@statsgen</a> <i class="fas fa-link"></i> <a href="">emitanaka.org/slides/rladiesSSA2020</a>
]
...
<div class="w3-display-container">
<center>
```{r beamer-slideshow2, echo = FALSE, results='asis'}
